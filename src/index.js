...
export {
  ...
  ViewLexiSdk,
  /**
   * The ViewAssistantSdk service constructor.
   * @property {module:base/Assistant/ViewAssistantSdk}
   */
  ViewAssistantSdk,
  /**
  ...
  ViewHealthcheckSdk,
  /**
   * The ViewStorageCheckSdk service constructor.
   * @property {module:base/Storage/ViewStorageSdk}
   */
  ViewStorageSdk,
  /**
   * The ViewStorageCheckSdk service constructor.
   * @property {module:base/Director/ViewDirectorSdk}
   */
  ViewDirectorSdk,
  /**
   * The ViewCrawlerSdk service constructor.
