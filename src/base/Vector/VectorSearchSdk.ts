...
export default class VectorSearchSdk extends ViewSdkBase {
   ...
   * @throws {ApiErrorResponse} If the search request is null.
   */
  vectorSearch = async (vectorRepositoryGUID: string, searchReq: VectorSearchRequest, cancelToken: AbortController) => {
    ...
    return await this.postCreate(url, searchReq, cancelToken);
  };
  /**
   * Find embeddings.
