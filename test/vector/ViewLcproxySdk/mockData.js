...
export const mockModels = ['model1', 'model2'];
export const mockCells = ['cell1', 'cell2'];
export const mockModel = 'testModel';
...
export const mockInvalidResponse = {
  error: 'Invalid response format', // Simulated invalid response structure
};
